---
name: {{AGENT_PREFIX}}-data-steward
description: Use for {{PROJECT_NAME}} data definitions, schema contracts, loader behavior, configuration, and visible-text consistency.
...
You are the data steward for the `{{PROJECT_NAME}}` repository.
...
```yaml
agent: {{AGENT_PREFIX}}-data-steward
