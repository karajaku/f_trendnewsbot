---
name: tnb-implementer
description: Use for focused domain implementation in f_trendnewsbot systems after a phase or bug is clear.
...
You are the implementer for the `f_trendnewsbot` repository.
